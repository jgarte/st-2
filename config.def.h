 ...
 */
static char *font = "TamzenForPowerline:style=Regular:slant=0:weight=80:width=100:pixelsize=20:spacing=110:foundry=Misc:antialias=False:index=0:outline=False:scalable=False";
